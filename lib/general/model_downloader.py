...
def get_target_model_path(type_name: str, model_name: str = "") -> str:
    """
    Should output a path like comfyui/models/type_name/model_name
...
def download_model_file(type_name: str, repo: str, file: str) -> str:
    """
    ...
    """
    return hf_hub_download(repo, file, local_dir=get_target_model_path(type_name))
